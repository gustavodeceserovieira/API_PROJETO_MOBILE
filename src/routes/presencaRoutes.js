...
import {getHistoricoPresenca, registraPresenca} from "../controllers/controllerPresenca.js";
...
router.get("/historico_presenca", jwtAuth, authorize(['ADMIN','USER']), getHistoricoPresenca);
