...
import {cadastraAluno, deletaAluno, editaAluno, getAlunos, getAlunosCategoria} from "../controllers/controllerAluno.js";
import {validarCampos} from "../middlewares/validacoesMiddleware.js";

const router = Router();

router.delete("/deleta_aluno", jwtAuth, authorize(['ADMIN']), validarCampos(['rg_aluno']), deletaAluno);
...
router.get("/get_alunos", jwtAuth, authorize(['ADMIN','USER']), getAlunos);
